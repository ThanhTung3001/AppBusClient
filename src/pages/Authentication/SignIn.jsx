...
import { loginAsync } from '../../app/reducer/user/userReducer';
...
const SignIn = () => {
  const validationSchema = Yup.object().shape({
    ...
    password: Yup.string()
      ...
      .matches(
        /^(?=.*[A-Z])/,
        'Mật khẩu phải có tối thiểu 1 từ viết hoá'
      )
      .required('Vui lòng điền mật khẩu đúng định dạng'),
  });
  ...
  return (
    <>
      ...
      <div className='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-[100vh] flex flex-col justify-center items-center'>
        <div className='flex flex-wrap items-center container'>
          <div className='hidden w-full xl:block xl:w-1/2'>
            <div className='py-17.5 px-26 text-center'>
              ...
              <p className='2xl:px-20 text-xl'>
                Ứng dụng đặt vé xe bus
              </p>
          ...
          <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
            <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
              {/* <span className='mb-1.5 block font-medium'>Đăng nhập</span> */}
              <h2 className='mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2'>
                Đăng nhập vào AppBus
              </h2>
              <Formik
                    ...
                    <div className='mb-6'>
                      ...
                      <div className='relative'>
                        <Field
                          type='password'
                          name='password'
                          placeholder='Trên 6 kí tự, 1 từ viết hoa'
                          className='w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
                        />
                        <span className='absolute right-4 top-4'>
                          <svg
