...
export default function GroupMenuInsert({ open, submit, onClose, data }) {
    const init = {
        value: null,
        label: 'Không chọn'
    }
    ...
    const InsertMenuSchema = Yup.object().shape({
        name: Yup.string().required('Không được để trống').min(3, 'Quá ngắn').max(50, 'Quá dài'),
        path: Yup.string().required('Không được để trống').max(50, 'Quá dài'),
    ...
    return (
        <Modal
            ...
            open={open}
        >
            <Modal.Header>Thêm mới menu</Modal.Header>
            <Modal.Content >
                <Formik
                    initialValues={{ name: '', icon: '', path: '', isActive: true }}
                        ...
                        <Form  >
                            <div className='grid grid-cols-2'>
                                ...
                                <div className='col-1 ml-2'>
                                    ...
                                    <Select options={menuList} onChange={(e) => setParentMenu(e)} value={parentMenu} />
