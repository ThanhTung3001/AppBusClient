...
export default function UserManagement() {
    return (
        <DefaultLayout>
            ...
            <div className='rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark h-[100%] flex flex-col justify-center items-center'>
                <CRUDTable
                ...
                >
                    <Fields>
                        <Field name="id" label="STT" hideInCreateForm />
                        <Field name="location" label="Tên đăng nhập" placeholder="Tên đăng nhập" />
                        <Field name="location" label="Thư điện tử" placeholder="Thư điện tử" />
                        <Field name="location" label="Đơn vị" placeholder="Tên đơn vị" />
                        <Field name="location" label="Là QTV" placeholder="Là QTV" />
