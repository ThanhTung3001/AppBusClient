...
export default function EnterpriseInfoEdit({ open, submit, onClose, data }) {
    ...
    const EditMenuSchema = Yup.object().shape({
        ...
        phoneNumber: Yup.string()
            .matches(/^(0|\+84)[3|5|7|8|9][0-9]{8}$/, 'Số điện thoại không đúng định dạng').optional(),
                            ...
                            <div className='grid grid-cols-2'>
                                <div className='col-1'>
                                    ...
                                    <Field
                                        ...
                                        className='w-full max-h-32 rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
                                    />
                                    <label className='mb-1 block text-black dark:text-white mt-3' >
                                        Số điện thoại
                                    </label>
