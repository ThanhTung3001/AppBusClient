...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  useEffect(() => {
    dispatch(fetchMenuByRole({ token: AppToken }));
                                    ...
                                    (e.children.map((item, index) => {
                                      ...
                                      return <li key={item.id}>
                                        <div
                                          ...
                                          className={
                                            'cursor-pointer group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                            (item.id == itemSelected && '!text-white')
                                          }
                                        >
                                          {item.name}
                                        </div>
